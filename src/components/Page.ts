...
export class Page extends Component<IPage> {
  ...
  constructor(container: HTMLElement, protected events: IEvents) {
    ...
    this._counter = provideElement<HTMLElement>('.header__basket-counter');
    this._store = provideElement<HTMLElement>('.gallery');
    this._wrapper = provideElement<HTMLElement>('.page__wrapper');
    this._basket = provideElement<HTMLElement>('.header__basket');
